...
---@overload fun(activationContext:System.ActivationContext): @static
---@overload fun(activationContext:System.ActivationContext, activationCustomData:string[]): @static
---@static
