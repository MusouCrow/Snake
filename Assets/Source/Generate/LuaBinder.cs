...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("Game");
		Game_BodyWrap.Register(L);
		Game_FactoryWrap.Register(L);
		Game_FoodWrap.Register(L);
		Game_GradientsWrap.Register(L);
		Game_GridFieldWrap.Register(L);
		Game_GridPositionWrap.Register(L);
		Game_GridUtilityWrap.Register(L);
		Game_HeadWrap.Register(L);
		Game_RestartWrap.Register(L);
		Game_SystemWrap.Register(L);
		Game_TestWrap.Register(L);
		L.EndModule();
